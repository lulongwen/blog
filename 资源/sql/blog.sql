...
INSERT INTO `blog_post` VALUES (28, 'Yii2.0-图片上传，富文本编辑器，标签组件', 'Yii2.0-图片上传，富文本编辑器，标签组件', '<p>将下载的yii2-tags-master 修改 tags ；</p><p><br/></p><p>注意：修改成其他文件名请修改插件内对应的命名空间，</p><p><br/></p><p>将文件放在 根目录/common/widgets 下即可</p><p><br/></p><p>标签样式添加到 ：frontend\\web\\css\\site.css</p><p><br/></p><p>&lt;?=$form-&gt;field($model,&#39;tags&#39;)-&gt;widget(&#39;common\\widgets\\tags\\TagWidget&#39;)?&gt;</p><p><br/></p>', '', 'yii2,yii2高级视频', 3, NULL, 3, 0, 1562941551, 1563100363, NULL);
INSERT INTO `blog_post` VALUES (29, 'YII DetailView', 'YII DetailView', '<p>Yii2 GridView 细节<br/></p><p>https://www.yiichina.com/tutorial/460</p>', '', 'Yii2框架,PHP高级,PHP进阶', 3, NULL, 5, 0, 1563097741, 1563114818, NULL);
COMMIT;
...
INSERT INTO `blog_post_status` VALUES (4, 28, 3, 120, 30, 90, NULL);
COMMIT;
